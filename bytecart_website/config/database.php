<?php
// Using MySQL (XAMPP) only; no MongoDB connections present.
...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mongodb_orders' => [
            'driver' => 'mongodb',
            // If MONGODB_ORDERS_DSN is set, it takes precedence over host/port.
            ...
            'options' => [
                // Authentication database (often "admin")
